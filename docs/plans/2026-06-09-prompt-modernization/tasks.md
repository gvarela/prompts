...
- [2026-06-11] Project re-scoped at Phase 3 close: Phase 4 trims DEFERRED to a successor project to run after wb-eval-harness (tasks prompts-41c/7jx/9wg/pnr/m7o and milestone prompts-6o3 deferred in beads; will be superseded into the successor). prompts-ogp re-scoped to "Cut the 2.0.0 release" and unblocked from the trim chain. Also landed under this project: plugin/ restructure (prompts-89d) and CHANGELOG/RELEASING (prompts-dqf). See research.md Final Disposition.
